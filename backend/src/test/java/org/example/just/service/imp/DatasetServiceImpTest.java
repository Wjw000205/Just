...
class DatasetServiceImpTest {
    ...
    @Test
    void getOnlineFormSchemaBuildsSectionsFromDatasetColumns() {
        ...
        when(datasetColumnDao.selectList(any())).thenReturn(List.of(
                datasetColumn(11, "材料编号", "varchar"),
                datasetColumn(12, "材料中文名称", "text")
        ));
        ...
        assertThat(result.getCode()).isEqualTo(0);
        assertThat(result.getMessage()).isEqualTo("success");
        assertThat(result.getData().getSections()).hasSize(1);
        ...
        assertThat(result.getData().getSections().get(0).getFields()).hasSize(3);
        assertThat(result.getData().getSections().get(0).getFields().get(0).getId()).isEqualTo("column11");
        ...
        assertThat(result.getData().getSections().get(0).getFields().get(1).getId()).isEqualTo("dataSource");
        assertThat(result.getData().getSections().get(0).getFields().get(1).getType()).isEqualTo("select");
        assertThat(result.getData().getSections().get(0).getFields().get(1).getOptions())
                .extracting("value")
                .containsExactly("experiment", "simulation");
        assertThat(result.getData().getSections().get(0).getFields().get(2).getId()).isEqualTo("column12");
    }
