...
CREATE TABLE `manu_dataset` (
  ...
  `cover_url` varchar(1024) DEFAULT NULL COMMENT '???URL',
  ...
  `science_category_id` int DEFAULT NULL COMMENT '????ID',
  `product_category_id` int DEFAULT NULL COMMENT '??/????ID',
  `data_level` varchar(32) DEFAULT NULL COMMENT '????',
  `data_category` varchar(32) NOT NULL DEFAULT 'dataset' COMMENT '????',
  `template_tag_id` int DEFAULT NULL COMMENT '????ID',
  `dataset_tag_ids` varchar(255) DEFAULT NULL COMMENT '?????ID??JSON',
...
INSERT INTO `manu_dataset` VALUES (1,'基础模板','',NULL,'admin','2026-03-24 17:11:23',0,1,0,NULL,NULL,NULL,NULL,'dataset',NULL,NULL,0),(2,'人物模板','',NULL,'admin','2026-03-24 17:11:43',1,1,0,NULL,NULL,NULL,NULL,'dataset',NULL,NULL,0),(3,'人物细节模板','',NULL,'admin','2026-03-24 17:31:07',2,0,0,NULL,NULL,NULL,NULL,'dataset',NULL,NULL,0),(4,'武器模板','',NULL,'admin','2026-03-24 19:27:09',1,1,0,NULL,NULL,NULL,NULL,'dataset',NULL,NULL,0),(5,'武器具体模板','',NULL,'admin','2026-03-24 19:32:35',4,0,0,NULL,NULL,NULL,NULL,'dataset',NULL,NULL,0);
...
INSERT INTO `module` VALUES (1,'用户管理模板','user','用于管理用户基础信息',1,1,1,0,'2026-03-31 16:47:54',0);
