...
CREATE TABLE `module` (
  ...
  `parent` varchar(255) DEFAULT NULL COMMENT '上级模板目录，null代表位第一级目录',
...
INSERT INTO `module` VALUES (1,'基础模板','admin','2026-03-24 17:11:23',NULL,1,0),(2,'人物模板','admin','2026-03-24 17:11:43','基础模板',1,0),(3,'人物细节模板','admin','2026-03-24 17:31:07','人物模板',0,0);
...
CREATE TABLE `module_column` (
  ...
  `module_name` varchar(255) NOT NULL COMMENT '所属的模板名',
...
INSERT INTO `module_column` VALUES (1,'角色名称','varchar','人物细节模板',0),(2,'职业','varchar','人物细节模板',0),(3,'等级','int','人物细节模板',0);
...
INSERT INTO `module_data` VALUES (1,1,1,'string','1',0),(2,2,1,'string','1',0),(3,3,1,'string','1',0),(4,1,2,'string','2',0),(5,2,2,'string','2',0),(6,3,2,'string','2',0);
...
-- Dump completed on 2026-03-24 18:11:13
