<template>
  <section class="data-disable-page">
    <div class="disable-layout">
      ...
      <main class="disable-main">
        ...
        <div class="disable-breadcrumb">
          ...
          <span class="crumb-current">数据停用</span>
        </div>

        <!-- 页面标题 -->
        <div class="disable-title">数据停用</div>
              ...
              <tr v-for="(item, index) in tableData" :key="item.id">
                ...
                <td class="col-action">
                  <div class="action-icons">
                    ...
                    <button class="icon-btn disable" title="停用" @click="handleDisable(item)">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <circle cx="12" cy="12" r="10"/>
                        <line x1="8" y1="12" x2="16" y2="12"/>
                      </svg>
...
const handleBatchDisable = () => {
  ...
  alert(`批量停用 ${selected.length} 条数据`)
}
